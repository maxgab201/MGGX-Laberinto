...
Acá quedan los APK firmados de cada versión, directo en el repositorio: es la
forma de bajar el juego mientras las releases de GitHub no estén disponibles.
...
Tiene que dar la misma huella SHA-256 que la tabla de arriba.
