...
alphas ni betas: lo que hay acá es una versión cerrada. Cada versión cerrada tiene ADEMAS su propia rama con el
número de versión (`1.0.0`, `1.1.0`, `1.2.0`, ... `1.6.0`, `1.7.0`), y ahí
...
|---|---|---|
| 1.7.0 | `MGGX-Laberinto-1.7.0.apk` | `A3:72:F9:5E:9E:EC:57:46:A2:66:8C:DA:F3:1C:56:6A:FC:97:39:B0:A4:49:A5:C1:6A:FA:66:86:52:4E:31:EE` |
