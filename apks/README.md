...
curso**: acá vive el APK más reciente. Las versiones siempre son x.y.z, sin
alphas ni betas: lo que hay acá es una versión cerrada.

Cada versión cerrada tiene ADEMÁS su propia rama con el número de versión
(`1.0.0`, `1.1.0`, `1.2.0`, ... `1.7.0`, `1.7.1`), y ahí adentro está su
propio `apks/` con el APK final de esa versión, más un `CAMBIOS.md` y un
`RELEASE.md` para cuando se publique como release de GitHub.

| Version | Archivo | Firma SHA-256 |
|---|---|---|
| 1.7.1 | `MGGX-Laberinto-1.7.1.apk` | `A3:72:F9:5E:9E:EC:57:46:A2:66:8C:DA:F3:1C:56:6A:FC:97:39:B0:A4:49:A5:C1:6A:FA:66:86:52:4E:31:EE` |
